...
_MEDICATIONS: set[str] = {
    "losartana", "losartan", "enalapril", "captopril", "metformina",
    "insulina", "omeprazol", "pantoprazol", "amoxicilina", "azitromicina",
    "ciprofloxacino", "cefalexina", "dipirona", "paracetamol", "ibuprofeno",
    "diclofenaco", "prednisona", "prednisolona", "dexametasona",
    "hidrocortisona", "furosemida", "espironolactona", "sinvastatina",
    "atorvastatina", "rosuvastatina", "clopidogrel", "varfarina",
    "heparina", "enoxaparina", "metoprolol", "atenolol", "propranolol",
    "carvedilol", "anlodipino", "nifedipino", "diltiazem", "verapamil",
    "levotiroxina", "amiodarona", "digoxina", "clonazepam", "diazepam",
    "fluoxetina", "sertralina", "escitalopram", "risperidona",
    "haloperidol", "quetiapina", "gabapentina", "pregabalina",
    "tramadol", "morfina", "codeina", "metoclopramida", "ondansetrona",
    "ranitidina", "bromoprida", "domperidona", "salbutamol", "fenoterol",
    "budesonida", "beclometasona", "formoterol", "tiotropio",
    "metronidazol", "fluconazol", "aciclovir", "oseltamivir",
    "ceftriaxona", "meropenem", "vancomicina", "gentamicina",
    "sulfametoxazol", "trimetoprima", "clindamicina", "doxiciclina",
    "rifampicina", "isoniazida", "pirazinamida", "etambutol",
    "glibenclamida", "glimepirida", "sitagliptina", "empagliflozina",
    "dapagliflozina", "liraglutida", "semaglutida", "pioglitazona",
    "alopurinol", "colchicina", "metotrexato", "ciclofosfamida",
    "tacrolimo", "micofenolato", "azatioprina",
}

_CONDITIONS: set[str] = {
    "hipertensao", "diabetes", "pneumonia", "infarto", "insuficiencia",
    "arritmia", "fibrilacao", "taquicardia", "bradicardia", "anemia",
    "trombose", "embolia", "isquemia", "hemorragia", "infeccao",
    "sepse", "choque", "edema", "dispneia", "tosse", "febre",
    "cefaleia", "dor", "nausea", "vomito", "diarreia", "constipacao",
    "ictericia", "ascite", "cianose", "hipotensao", "hipoglicemia",
    "hiperglicemia", "hipercalemia", "hipocalemia", "acidose",
    "alcalose", "desidratacao", "obesidade", "desnutricao",
    "insuficiencia renal", "insuficiencia hepatica",
    "insuficiencia cardiaca", "insuficiencia respiratoria",
    "doenca pulmonar obstrutiva cronica", "asma", "bronquite",
    "tuberculose", "meningite", "encefalite", "acidente vascular",
    "epilepsia", "convulsao", "parkinson", "alzheimer", "demencia",
    "depressao", "ansiedade", "esquizofrenia", "hipotireoidismo",
    "hipertireoidismo", "cirrose", "hepatite", "pancreatite",
    "colecistite", "apendicite", "diverticulite", "gastrite",
    "ulcera", "neoplasia", "tumor", "cancer", "leucemia", "linfoma",
    "fratura", "luxacao", "entorse", "artrite", "artrose", "osteoporose",
    "lupus", "covid-19", "sars-cov-2", "dengue", "malaria",
}

_PROCEDURES: set[str] = {
    "cirurgia", "biopsia", "endoscopia", "colonoscopia", "broncoscopia",
    "laparoscopia", "tomografia", "ressonancia", "radiografia",
    "ultrassonografia", "ecografia", "ecocardiograma", "cateterismo",
    "angioplastia", "revascularizacao", "transplante", "dialise",
    "hemodialise", "intubacao", "traqueostomia", "drenagem",
    "paracentese", "toracocentese", "puncao", "aspiracao",
    "transfusao", "quimioterapia", "radioterapia", "imunoterapia",
    "fisioterapia", "fonoterapia", "nutricao enteral",
    "nutricao parenteral", "sutura", "desbridamento", "amputacao",
    "artroscopia", "artrodese", "mastectomia", "colecistectomia",
    "apendicectomia", "histerectomia", "prostatectomia",
    "nefrectomia", "gastrectomia", "colostomia", "ileostomia",
    "hemograma", "gasometria", "urocultura", "hemocultura",
    "eletrocardiograma", "holter", "mapa",
}
...
class ClinicalNER:
    ...
    def extract(self, text: str) -> list[ClinicalEntity]:
        ...
        entities.extend(self._extract_from_gazetteer(
            text, self._medications, EntityType.MEDICAMENTO,
        ))

        # Step 4: Extract conditions (gazetteer)
        entities.extend(self._extract_from_gazetteer(
            text, self._conditions, EntityType.CONDICAO,
        ))

        # Step 5: Extract procedures (gazetteer)
        entities.extend(self._extract_from_gazetteer(
            text, self._procedures, EntityType.PROCEDIMENTO,
        ))
